...
<div id="middle">
	 ...
	 <!--  购物车 -->
	 <div id="product_info">
			<div class="title">个人中心  &gt;&gt;  求购商品详情</div>
			<div style="margin-top:5px">
				 <table class="ptable" style="margin-bottom:5px;">
			        <tr>
			          <td width="40%" align="center">
			          	<img src="images/buy.jpg" width="100" /> 
			          </td>
			          <td width="60%" style="line-height:22px;">
			          	商品名称：<s:property value="#attr.goods.goods_name"/>
			          	<br/>期望价格：￥<s:property value="#attr.goods.goods_price"/> 元
			          	<br/>买家手机：<s:property value="#attr.goods.user_phone"/>
			          	<br/>买家QQ：<s:property value="#attr.goods.user_qq"/>
