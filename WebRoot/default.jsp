	...
	<div id="right">
		...
		<div id="list">
			<div class="products">
				...
				<div class="product">
					<div class="productPic"><s:a href="page_queryGoods.action?paramsGoods.goods_id=%{#goods.goods_id}" target="_blank"><img src="images/goodss/<s:property value='#goods.goods_pic'/>"></s:a></div>
					<div class="productText">
						 <span class="title"><s:property value='#goods.goods_name'/></span>
						<br/>价格：￥<s:property value='#goods.goods_price'/>
						<br/>可否小刀：<s:property value='#goods.goods_saleDesc'/>
					</div>
				</div>
				</s:iterator>
				</s:if>
