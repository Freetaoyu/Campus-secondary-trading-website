  ...
  <tr>
    ...
    <td width="" align="right">
      ...
      <s:select id="paramsOrders.orders_flag" name="paramsOrders.orders_flag" value="%{#attr.paramsOrders.orders_flag}" 
      		list="#{'1':'待发货','2':'已发货','3':'已收货'}" listKey="key" listValue="value" 
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="<s:if test='(#status.index + 1)%2==0'>list1</s:if><s:else>list0</s:else>" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">&nbsp;
       <s:if test="#orders.orders_flag==1 && #attr.admin.user_type==2">
       <s:a href="Admin_sendOrders.action?paramsOrders.orders_id=%{#orders.orders_id}">发货</s:a>&nbsp;&nbsp;
       </s:if>
