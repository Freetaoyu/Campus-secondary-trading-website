...
$(document).ready(function(){
	$("#buyTopBtn").bind("click",function(){
 		...
 		window.open("page_listMyGoodsExchanges.action", "商品交换")
 	});
	
	//搜索
 	$("#big_searchBtn").bind("click",function(){
 		$("#info").attr("action","page_goodsExchange.action").removeAttr("target").submit();
 	});
...
<div id="mainArea">
	<div class="mainArea2">
		<div class="buyTop" style="background-image:url('images/want-title2.png'); ">			
			 <input type="button"  id="buyTopBtn" value="发布交换" class="btnstyle"/>
		</div>	 
	</div>
	...
	<div class="mainArea2" style="background-color: white;margin-left:5px;margin-top:5px;width:985px">
		...
		<div id="contentShow">
			<span style="color:#00947e;font-weight:bold;font-size:14px;">[交换] <s:property value='#goods.goods_name'/></span>
			<br/><s:property value='#goods.goods_desc' escape="false"/>
			<br/>弥补差价	¥<s:property value='#goods.goods_price'/>&nbsp;&nbsp;&nbsp;&nbsp;
...
<script language="javascript" type="text/javascript">
	function GoPage()
	{
	  ...
	  document.info.action="page_goodsExchange.action";
