...
<html>
<head>
<title><s:if test="#attr.goods!=null && #attr.goods.goods_id!=0">编辑</s:if><s:else>新增</s:else>商品交换</title>
...
<div id="middle">
	<jsp:include page="leftMenu.jsp"></jsp:include>
	 <!--  购物车 -->
	 <div id="product_info">
			<div class="title">个人中心  &gt;&gt;  <s:if test="#attr.goods!=null && #attr.goods.goods_id!=0">编辑</s:if><s:else>新增</s:else>商品交换</div>
			<div style="margin-top:5px">
				 ...
				 <input type="hidden" name="paramsGoods.goods_flag" id="paramsGoods.goods_flag" value="3"/>
