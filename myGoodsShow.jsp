...
<div id="middle">
	 ...
	 <!--  购物车 -->
	 <div id="product_info">
			<div class="title">个人中心  &gt;&gt;  我的商品发布</div>
			<div style="margin-top:5px">
				 <form id="infoSelf" name="infoSelf" action="page_listMyGoodss.action" method="post" style="width:100%;height:100%">
				 ...
				 <table class="ptable" style="margin-bottom:5px;">
				 	<tr>
					     <td colspan="9" align="right">
					     	...
					     	<input type="button" value="新增" onclick="window.location.href='page_addGoodsShow.action';" class="btnstyle"/>
					     </td>
					</tr>
					<tr class="head_text">
					...
					<s:if test="#attr.goodss!=null && #attr.goodss.size()>0">
					   ...
					   <tr> 
					     <td width="" align="center" title='<s:property value="#goods.goods_name"/>'>
					     	<s:a href="page_queryMyGoods.action?paramsGoods.goods_id=%{#goods.goods_id}">
					     ...
					     <td width="" align="center"><s:property value="#goods.goods_saleDesc"/></td>
					     <td width="" align="center"><s:property value="#goods.goods_date.substring(0,19)"/></td>
					     <td width="" align="center">
					       <s:a href="page_editGoods.action?paramsGoods.goods_id=%{#goods.goods_id}">编辑</s:a>&nbsp;
				    ...
				    <s:else>
				    <tr>
				      <td height="60" colspan="9" align="center"><b>&lt;不存在商品发布信息&gt;</b></td>
				    </tr>
				    </s:else>
				 </table>
				 </form>
...
<script language="javascript" type="text/javascript">
	function serch()
	{
	   document.infoSelf.action="page_listMyGoodss.action";
