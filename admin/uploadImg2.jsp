...
<body bgcolor="#DFEDFF">
<form name="upImgFrm" method="post" action="UploadImg.action?num=2" style="padding:0px;margin:0px;" enctype="multipart/form-data">
...
<!--  
  ...
  if(flag=='ok')
  {
    var userPhoto= window.parent.document.getElementById("paramsInfo.info_pic");
    ...
    window.parent.document.getElementById("userImg").src="../images/infos/"+filename;
  }
  else if(flag=='no')
  {
    window.parent.document.getElementById("op").style.display="none";
