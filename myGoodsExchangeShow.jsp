					...
					<s:if test="#attr.goodss!=null && #attr.goodss.size()>0">
					   ...
					   <tr> 
					     <td width="" align="center" title='<s:property value="#goods.goods_name"/>'>
					     	<s:a href="page_queryMyGoodsExchange.action?paramsGoods.goods_id=%{#goods.goods_id}">
					     ...
					     <td width="" align="center">
					       <s:a href="page_editGoodsExchange.action?paramsGoods.goods_id=%{#goods.goods_id}">编辑</s:a>&nbsp;
